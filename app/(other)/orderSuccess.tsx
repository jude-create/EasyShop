      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 24 }}>
        ...
        <Animated.View style={{ alignItems: 'center', opacity, transform: [{ translateY: slideUp }], width: '100%' }}>
          ...
          <Text style={{ fontSize: 14, color: colors.textSecondary, textAlign: 'center', lineHeight: 21, marginBottom: 28 }}>
            Your order has been confirmed. We will send you a notification when it is on its way.
          </Text>
            ...
            {DETAILS.map((d, i) => (
              <View
                ...
                style={{
                  ...
                  padding: 14,
                  gap: 12,
                  borderBottomWidth: i < DETAILS.length - 1 ? 0.5 : 0,
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: 14, fontWeight: '600', color: colors.text, marginTop: 1 }}>
                    {d.value}
                  </Text>
                </View>
              </View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
          >
            <Text style={{ color: colors.text, fontWeight: '600', fontSize: 16, letterSpacing: -0.2 }}>
              Continue Shopping
            </Text>
          </TouchableOpacity>
        </Animated.View>
